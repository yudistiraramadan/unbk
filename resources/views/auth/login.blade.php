...
<html dir="ltr">
  <head>
    ...
    <link
      ...
      type="image/png"
      sizes="16x16"
      href="{{ asset('flexy/assets/images/favicon.png') }}"
    />
    <!-- Custom CSS -->
  ...
  <body>
    <div class="main-wrapper">
      ...
      <div
        ...
        "
        style="
          background: url(flexy/assets/images/background/login-register.jpg)
      ...
      >
        <div class="auth-box p-4 bg-white rounded">
          <div id="loginform">
            <div class="logo">
              <h3 class="box-title mb-3">Login Sistem</h3>
            </div>
            <!-- Form -->
            <div class="row">
              <div class="col-12">
                <form class="form-horizontal mt-3 form-material" id="loginform" action="{{ route('postlogin') }}" method="post">
                    @csrf
